...
En cada ciclo Sprint del flujo de trabajo se practican cinco actividades Scrum: refinamiento de producto, planificación, reunión diaria, revisión de producto y retrospectiva. La actividad de  refinamiento de producto no suele tener un nombre unificado; pues, se la suele llamar "Backlog Grooming", Manteniemiento de Baclog o Refinamiento.
