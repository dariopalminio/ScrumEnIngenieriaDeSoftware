...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.5]{ScrumSystemCore}
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.7]{ScrumRolesSystem}
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.6]{ScrumFlow}
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.45]{ScrumArtifactsStockFlow}
