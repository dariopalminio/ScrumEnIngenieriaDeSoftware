...
\item Buscar lograr un entorno seguro y de apoyo que genere confianza y respeto mutuo.
\item Buscar establecer acuerdos claros y que se cumpla lo pactado.
\item Considerar diferentes formas de trabajar con el equipo Scrum buscando aplicar las más adecuadas según el contexto.
\item Buscar comprender la esencia de la comunicación en los diálogos del equipo Scrum y ayúdar a concretar sus acciones y su entendimiento.
...
\subsection{Definición de listo}

La definición de listo, "Definition of Ready" o DoR es una Definición de Terminado particular que se corresponde con las condiciones para que un PBI pueda pasar a formar parte de un Sprint Backlog. Si un PBI no cumple con su DoR no puede ser tomado en una planificación para ser ítem de trabajo del Sprint planeado, ya que es un ítem que no está listo para ser comprometido.
