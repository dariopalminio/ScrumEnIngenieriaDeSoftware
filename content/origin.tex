...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.6]{WaterfallModel}
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.45]{PMIMethodology}
...
\item \textbf{Gestión Centralizada:} La organización de la gestión tradicional es centralizada. Es centralizada porque se centra en el gerente de proyectos y en una forma de liderazgo de mando y control. 
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.8]{PMIProject}
