...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.80\textwidth]{Scrum_Flow_basic_ScrumGuide2017}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.99\textwidth]{Scrum_Flow_advanced}
  \caption{Flujo de Scrum avanzado ejemplo}
  \centering
  \label{fig:Scrum_Flow_advanced} %\ref{fig:Scrum_Flow_advanced}
\end{figure}
...
En síntesis, debemos ser libres de adaptar Scrum o potenciarlos como consideremos apropiado. Ser libres de experimentar.
