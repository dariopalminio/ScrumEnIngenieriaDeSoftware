...
ATDD (Acceptance Test Driven Development) es una metodología en la cual todo el equipo discute en colaboración criterios de aceptación de una historia de usuario, con ejemplos, y luego crea un conjunto de pruebas de aceptación en forma de escenarios (por ejemplo en formato Gherkin) en concreto. Continuadamente se automatiza la prueba de aceptación de los escenarios que fallarán (fail) en su primera corrida.  Luego recién se procede a programar la implementación de la historia de usuario para que pase (pass) los escenarios. Aquí es donde se relaciona con TDD, ya que la implementación del código de la historia se puede hacer usando la técnica TDD. Este proceso se repite por cada historia de usuario. Las herramientas para trabajar con ATDD incluirían a Cucumber y Fitnesse, entre otras.
