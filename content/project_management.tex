...
Esta definición es algo genérica. Hay dos formas más específicas de interpretar y medir la velocidad:

\begin{enumerate}
  \item{Cuando la velocidad muestra solo la cantidad de funcionalidad de valor que un equipo entrega en un sprint. En este sentido las historia de usuario que no tienen ningún valor para el cliente o incompletas, las correcciones de errores y las refactorizaciones no cuentan en la velocidad.}

  \item{Cuando la velocidad muestra la cantidad de funcionalidad que un equipo entrega en un sprint incluyendo las de valor indirecto. En este sentido las historia de usuario completadas que tienen valor indirecto para el cliente, las correcciones de errores y las refactorizaciones si cuentan en la velocidad.}
\end{enumerate}
