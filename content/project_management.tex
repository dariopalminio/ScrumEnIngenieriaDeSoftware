...
Scott y Jeff definen las siguientes métricas útiles \cite{Scott-Jeff-2013}:

\begin{enumerate}
\item Velocity
\item Work Capacity
\item Focus Factor
\item Percentage of Adopted Work
\item Percentage of Found Work
\item Accuracy of Estimation
\item Accuracy of Forecast
\item Targeted Value Increase (TVI+)
\item Success at Scale
\end{enumerate}
